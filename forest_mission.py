...
def main_program():
    ...
    gizmo.stally
    gizmo.go_forward(0.1)#go into the statue
    gizmo.stally
    gizmo.d_turn_angle(850,140)
    gizmo.c_turn_angle(1000, 680)
    gizmo.stally
    gizmo.go_reverse(0.5)
    gizmo.stally
    gizmo.c_turn_angle(1000, 150)
    gizmo.c_turn_angle(-1000, 350)
    gizmo.stally
    gizmo.go_reverse(5)
    ...
    # gizmo.go_forward(7)
    # gizmo.turn_left_degrees(60)
    # gizmo.go_forward(4)
    # gizmo.d_turn_angle(600, 540)
    # gizmo.go_reverse(3.5)
